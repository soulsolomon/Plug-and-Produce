...
class InformCoordinates:
    ...
    def giveInform(self):
        ...
        FreeCAD.Console.PrintMessage("The Selected Nail is " + self.name)
        FreeCADGui.Selection.addSelection('TreeCell',self.name)
        sel = FreeCADGui.Selection.getSelection()
        # returns a array of three coordinates of positions
        placeMotor = sel[1].Placement.Base
        ...
        orientMotor = sel[1].Placement.Matrix
